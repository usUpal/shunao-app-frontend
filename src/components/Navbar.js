...
function Navbar() {
  ...
  return (
    <div>
      <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded bg-gray-200">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
          <a href='/' class="flex items-center">
            <img  src={logo} class="mr-3 h-6 sm:h-9"  />
            <div class="hidden w-full md:block md:w-auto" id="mobile-menu">Shunao</div>
          </a>
          <button
          ...
          <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
            <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              ...
              <li>
                  <button onClick={() => logout()} className="bg-transparent px-6 font-bold">Logout</button>
              </li>
            </ul>
          </div>
        </div>
